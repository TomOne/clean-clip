; Copied from https://github.com/cocobelgica/AutoHotkey-Util/blob/master/StdOutToVar.ahk,
; but inserted UTF-8 as character encoding instead of CP0
...
StdOutToVar(cmd) {
	...
	while DllCall("ReadFile", "Ptr", hReadPipe, "Ptr", &buffer, "UInt", 4096, "UIntP", dwRead, "Ptr", 0)
		sOutput .= StrGet(&buffer, dwRead, "UTF-8")
