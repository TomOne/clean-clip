; This file was slightliy modified to support UTF-8 output for SetHTML().
; In addition the newlines between the output body tag and the HTML
...
SourceURL:%source%
<html><body><!--StartFragment-->%htmlData%<!--EndFragment--></body></html>
    )
